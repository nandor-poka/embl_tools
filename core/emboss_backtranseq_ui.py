...
__name__ = 'emboss_backtanseq_ui'
gui.service_cmd = 'python3 ../embl_client/emboss_backtanseq.py' # TODO replace service.py with real embl client python file name. Path is relative to the ui notebook, not this file.
gui.app_label.value= 'EMBL-Tools Backtranseq webservice' # TODO replace with real application label text
