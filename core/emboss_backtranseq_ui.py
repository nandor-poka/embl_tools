...
gui.service_cmd = 'python3 ../embl_client/emboss_backtanseq.py'
gui.app_label.value= 'EMBL-Tools Backtranseq webservice - back-translate a protein sequence to a nucleotide sequence.'

codon_table_options = []
databases_xml = ET.parse(gui.__file_path__+'/../core/emboss_backtranseq_codon_table.xml')
