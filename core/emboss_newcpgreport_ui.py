...
__name__ = 'emboss_newcpgreport_ui'
gui.service_cmd = 'python3 ../embl_client/emboss_newcpgreport.py'
gui.app_label.value= 'EMBL-Tools emboss_newcpgreport_ui webservice'
